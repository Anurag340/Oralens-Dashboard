...
const Fifth = () => {
  return (
    <div className=' relative h-screen w-full flex flex-col justify-center items-center gap-[3vh] ' >
      ...
      <div className='flex flex-col gap-[1vw] text-white justify-center items-center w-[40%] ' >

        <div className='bg-blue-800 rounded-md flex flex-col gap-[1vh] w-[55%] py-[4vh] pl-[1.5vw] ' >
        ...
        <div className='bg-blue-800 rounded-md flex flex-col justify-center items-center gap-[3vh] w-[55%] py-[2vh] ' >
        <div className='flex flex-col justify-center items-center gap-[1vw] '>
          ...
          <div className='flex justify-center items-center gap-[1vh]'>
            ...
            <GrGallery size={30} />
            <input type="file" className='bg-blue-600 w-[6.5vw]' />
          </div>
        </div>

        <button className='p-[.2vh] px-[1vh] rounded-full bg-white text-black '>Upload Img</button>
