    ...
    <div className='h-screen w-full relative ' >
      ...
      <div className='flex justify-center items-center h-full w-full' >
        <div className=' herodiv h-[80%] w-[50%] flex flex-col justify-around ' >
          ...
          <button onClick={()=>{navigate('/individual-register')}} className='flex justify-center items-center w-fit  bg-white px-[2vh] rounded-full ' >Proceed <GoArrowRight/></button>
          </div>
        ...
        <div className=' seconddiv h-[80%] w-[50%] flex justify-center items-center ' >
          <div className='h-full w-[70%] bg-blue-900 rounded-xl py-[3vw] flex flex-col justify-around items-center ' >
            ...
            <form className='w-[80%] bg-blue-800 py-[2vw] rounded-xl flex flex-col gap-[2vh] justify-center items-center text-white ' action="">
              <label>
                <p>Unit No :</p>
                <input placeholder='  Enter unit no' className= ' inputs bg-zinc-200 rounded-md mt-[.5vh]' type="text" />
              </label>

              <label>
                <p>Department :</p>
                <input type="text" placeholder='  Enter department' className=' inputs bg-zinc-200 rounded-md mt-[.5vh]' />
              </label>
